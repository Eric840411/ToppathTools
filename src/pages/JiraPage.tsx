              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 8 }}>
                ...
                <div>
                  ...
                  <div style={{ position: 'relative', cursor: 'pointer' }} onClick={e => { const inp = (e.currentTarget as HTMLDivElement).querySelector('input'); inp?.showPicker?.() }}>
                    <input type="date" className="lark-url-input date-input-custom" style={{ width: '100%', cursor: 'pointer', WebkitTextFillColor: reconcileFrom ? undefined : 'transparent', boxSizing: 'border-box' }} value={reconcileFrom} onChange={e => setReconcileFrom(e.target.value)} />
                ...
                <div>
                  ...
                  <div style={{ position: 'relative', cursor: 'pointer' }} onClick={e => { const inp = (e.currentTarget as HTMLDivElement).querySelector('input'); inp?.showPicker?.() }}>
                    <input type="date" className="lark-url-input date-input-custom" style={{ width: '100%', cursor: 'pointer', WebkitTextFillColor: reconcileTo ? undefined : 'transparent', boxSizing: 'border-box' }} value={reconcileTo} onChange={e => setReconcileTo(e.target.value)} />
